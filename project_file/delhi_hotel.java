 ...
 */
import java.sql.*;
public class delhi_hotel extends javax.swing.JFrame {
     Connection con;
    Statement st;
    ResultSet rs;
    String sql="",s,nm;
    ...
    /**
     * Creates new form delhi_hotel
     */
    public delhi_hotel(int x,String t) {
        initComponents();
         a=x;
         s=t; 
 try
 {    
     ...
     if(a==0)
     {
        ...
        sql="select * from delhi where sno=0";
        st=con.createStatement();
        rs=st.executeQuery(sql);
        if(rs.next())
     rb1.setText(rs.getString("hotel")+"\n");
    
      sql="select * from delhi where sno=1";
        st=con.createStatement();
        rs=st.executeQuery(sql);
        if(rs.next())
     ...
     if(a==1)
     {
        Class.forName("java.sql.DriverManager");
        con=DriverManager.getConnection("jdbc:mysql://localhost:3307/project","root","1234");
        sql="select * from delhi where sno=2";
        st=con.createStatement();
        rs=st.executeQuery(sql);
        if(rs.next())
     rb1.setText(rs.getString("hotel")+"\n");

      sql="select * from delhi where sno=3";
        st=con.createStatement();
        rs=st.executeQuery(sql);
        if(rs.next())
     rb2.setText(rs.getString("hotel")+"\n");
     ...
     if(a==2)
     {
        Class.forName("java.sql.DriverManager");
        con=DriverManager.getConnection("jdbc:mysql://localhost:3307/project","root","1234");
        sql="select * from delhi where sno=4";
        st=con.createStatement();
        rs=st.executeQuery(sql);
        if(rs.next())
     rb1.setText(rs.getString("hotel")+"\n");

      sql="select * from delhi where sno=5";
        st=con.createStatement();
        rs=st.executeQuery(sql);
        if(rs.next())
     rb2.setText(rs.getString("hotel")+"\n");
     ...
     if(a==3)
     {
        Class.forName("java.sql.DriverManager");
        con=DriverManager.getConnection("jdbc:mysql://localhost:3307/project","root","1234");
        sql="select * from delhi where sno=6";
        st=con.createStatement();
        rs=st.executeQuery(sql);
        if(rs.next())
     rb1.setText(rs.getString("hotel")+"\n");
     ...
     if(a==3)
     {
      sql="select * from delhi where sno=7";
        st=con.createStatement();
        rs=st.executeQuery(sql);
        if(rs.next())
     rb2.setText(rs.getString("hotel")+"\n");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        nm=rb2.getText().trim();
        new roomdelhi(nm).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delhi_hotel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new delhi_hotel().setVisible(true);
            }
        });
    }
